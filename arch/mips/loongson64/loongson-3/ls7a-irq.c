...
unsigned int ls7a_ipi_irq2pos[128] = {
	[0 ... 127] = -1,
	[LS7A_PCH_GMAC0_SBD_IRQ] = 0,
	[LS7A_PCH_GMAC1_SBD_IRQ] = 1,
	[LS7A_PCH_SATA0_IRQ] = 2,
	[LS7A_PCH_SATA1_IRQ] = 3,
	[LS7A_PCH_SATA2_IRQ] = 4,
	[LS7A_PCH_EHCI0_IRQ] = 5,
	[LS7A_PCH_OHCI0_IRQ] = 6,
	[LS7A_PCH_EHCI1_IRQ] = 7,
	[LS7A_PCH_OHCI1_IRQ] = 8,
	[LS7A_PCH_PCIE_F0_PORT0_IRQ] = 9,
	[LS7A_PCH_PCIE_F0_PORT1_IRQ] = 10,
	[LS7A_PCH_PCIE_F0_PORT2_IRQ] = 11,
	[LS7A_PCH_PCIE_F0_PORT3_IRQ] = 12,
	[LS7A_PCH_PCIE_F1_PORT0_IRQ] = 13,
	[LS7A_PCH_PCIE_F1_PORT1_IRQ] = 14,
	[LS7A_PCH_PCIE_G0_LO_IRQ] = 15,
	[LS7A_PCH_PCIE_G0_HI_IRQ] = 16,
	[LS7A_PCH_PCIE_G1_LO_IRQ] = 17,
	[LS7A_PCH_PCIE_G1_HI_IRQ] = 18,
	[LS7A_PCH_PCIE_H_LO_IRQ] = 19,
	[LS7A_PCH_PCIE_H_HI_IRQ] = 20
};
...
void ls7a_irq_dispatch(void)
{
	...
	unsigned int irq, irqs;
	unsigned long intstatus = readq(LS7A_INT_STATUS_REG);
...
void ls7a_init_irq(void)
{
	...
	writeq(0ULL, LS7A_INT_EDGE_REG);
	writeq(0ULL, LS7A_INT_MASK_REG);
	writeq(0ULL, LS7A_INT_STATUS_REG);
