...
const struct i2c_board_info __initdata ls7a_adv7511_eep_info = {
	I2C_BOARD_INFO("adv7511", 0x3d),
};
...
static void __init ls7a_arch_initcall(void)
{
	...
	i2c_register_board_info(6, &ls7a_adv7511_eep_info, 1);
	i2c_register_board_info(7, &ls7a_fb_edid_eep_info, 1);
}
