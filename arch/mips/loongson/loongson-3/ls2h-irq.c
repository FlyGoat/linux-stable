...
unsigned int ls2h_ipi_irq2pos[224] = {
	...
	[LS2H_PCH_OHCI_IRQ] = 1,
	[LS2H_PCH_OTG_IRQ] = 2,
	[LS2H_PCH_GMAC0_IRQ] = 3,
	[LS2H_PCH_GMAC1_IRQ] = 4,
	[LS2H_PCH_SATA_IRQ] = 5,
	[LS2H_PCH_PCIE_PORT0_IRQ] = 6,
	[LS2H_PCH_PCIE_PORT1_IRQ] = 7,
	[LS2H_PCH_PCIE_PORT2_IRQ] = 8,
	[LS2H_PCH_PCIE_PORT3_IRQ] = 9
};
...
void ls2h_irq_dispatch(void)
{
	...
	unsigned int i, intstatus, irq, irqs;
